"""Regression checks for the copper-ops-bundle-plane casebook."""
...
from casebook.harness import assert_expected, copper_ops_bundle_plane_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(copper_ops_bundle_plane_summary(), assert_expected())
