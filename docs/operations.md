...
`copper-ops-bundle-plane` is centered on automation work in JavaScript. The technical target is: Develop a JavaScript command-oriented project for bundle scenarios with layout fixtures, stable geometry snapshots, and bounded memory input sets.
...
The score is deterministic. The current threshold is 160. Risk has a penalty of 6, latency has a penalty of 2, and weight contributes a bonus of 6.
