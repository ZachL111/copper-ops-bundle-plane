...
powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-copper-ops-bundle-detail.ps1

node tests/domainReview.test.js

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-copper-ops-bundle-properties.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-copper-ops-bundle-golden.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-copper_ops_bundle_plane-casebook.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }
